...
Before opening a new issue, please consider:
  ...
  - Finally, **[open an issue]**(https://github.com/slackapi/hubot-slack/issues/new) to report a bug, ask for help or suggest a feature. The more information you give, the better people can help you.
...
- [Fork the repository](https://github.com/slackapi/slack-hubot) and make sure to work on a branch up to date with origin master.
- Do your thing!
